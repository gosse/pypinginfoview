...
hosts = ['1.1.1.1', '1.0.0.1', '8.8.8.8', '8.8.4.4', 'canireachthe.net', '208.67.220.220', '208.67.222.222']
...
if __name__ == "__main__":
  ...
  parser.add_argument('-i', '--interval', type=int, default=1, help='ping interval', metavar='i')
  parser.add_argument('-t', '--timeout', type=int, default=2, help='ping timeout', metavar='i')
